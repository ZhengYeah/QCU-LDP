...
if __name__ == '__main__':
    ...
    with open('appendix_lr_accuracy.csv', 'w') as f:
        f.write('epsilon,pm_theo,pm_empirical,sw_theo,sw_empirical,krr_theo,krr_empirical,gaussian_theo,gaussian_empirical\n')
        for epsilon in range(1, 9):
            f.write(f'{epsilon}')
            for mechanism in ["pm", "sw", "krr", "gaussian"]:

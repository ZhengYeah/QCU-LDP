...
model.eval()
private_image = np.load('../experiments/mnist/mnist_7_7_0.npy')
...
plt.plot(epsilon_values, theoretical_accuracies["pm"], label="PM Theoretical", marker='o')
plt.plot(epsilon_values, empirical_accuracies["pm"], label="PM Empirical", marker='o', linestyle='--')
plt.plot(epsilon_values, theoretical_accuracies["sw"], label="SW Theoretical", marker='s')
plt.plot(epsilon_values, empirical_accuracies["sw"], label="SW Empirical", marker='s', linestyle='--')
plt.plot(epsilon_values, theoretical_accuracies["exp"], label="EXP Theoretical", marker='^')
plt.plot(epsilon_values, empirical_accuracies["exp"], label="EXP Empirical", marker='^', linestyle='--')
plt.plot(epsilon_values, theoretical_accuracies["krr"], label="KRR Theoretical", marker='d')
plt.plot(epsilon_values, empirical_accuracies["krr"], label="KRR Empirical", marker='d', linestyle='--')
